...
document.querySelectorAll('nav ul li a').forEach(anchor => {
  ...
  backToTopBtn.style.backgroundColor = '#7b0c0c';
  ...
  function toggleSkills(categoryId) {
    var skillBox = document.querySelector("#" + categoryId + " .skill-box-container");
    skillBox.classList.toggle("show");
  }
  ...
  // Toggle visibility of technical skills when heading is clicked
document.querySelector('#technical-skills h3').addEventListener('click', function() {
  const skillList = document.querySelector('#technical-skills .skill-list');  // Get the skill list
  skillList.classList.toggle('hidden');  // Toggle hidden class
});
